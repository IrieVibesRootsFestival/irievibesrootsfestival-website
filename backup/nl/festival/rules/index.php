    ...
    <body>
        ...
        <div class="content container">
            ...
            <div id="rules" class="container">
                ...
                <p class="text-white">--> FESTIVAL RULES</p>
                ...
                <ul><li>Empty reusable bottles to fill up with water at the waterbar</li></ul>
                <hr/>
                <p class="text-white">--> FACILITIES</p>
                <ul>
                    <li><b>CSP (Central Security Point)</b>: ready to help you out with all kinds of questions about safety at Irie Vibes.  You can also get free earplugs, sunscreen for the children, Irie Vibes tshirts, gadgets and pocket ash trays.</li>
                    ...
                    <li><b>Food Stands + Bar</b>: There will be plenty food stands available and 3 bars (main bar, dub bar and coffee/cocktail bar)</li>
