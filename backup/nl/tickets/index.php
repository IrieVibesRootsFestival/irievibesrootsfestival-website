                        ...
                        <span class="navbar-text">
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link language text-muted" href="/en/tickets/">EN<span class="sr-only">(current)</span></a>
                                </li>
                            </ul>
                        </span>
                    </div>
        ...
        <div class="container">
            ...
            <div class="container">
                <div id="prices" class="row">
                    <div class="col-sm-4 text-center" data-toggle="tooltip" data-placement="bottom" title="UITVERKOCHT">
                        <h3><s>Early Bird</s></h3>
                        <div class="price"><s>Vrijdag: N/B</s></div>
                        <div class="price"><s>Zaterdag: N/B</s></div>
                        <div class="price"><s>Weekend: €30</s></div>
                    </div>
                    <div class="col-sm-4 text-center" data-toggle="tooltip" data-placement="bottom" title="UITVERKOCHT">
                        <h3><s>Voorverkoop</s></h3>
                        <div class="price"><s>Vrijdag: €25</s></div>
                        <div class="price"><s>Zaterdag: €30</s></div>
                        <div class="price"><s>Weekend: €40</s></div>
                    </div>
                    <div class="col-sm-4 text-center">
                        <h3>Inkom</h3>
                        <div class="price">Vrijdag: €30</div>
                        <div class="price">Zaterdag: €35</div>
                        <div class="price">Weekend: €45</div>
                    </div>
                </div>
                <hr/>
            </div>
...
<iframe class="widget "src="https://eventbrite.be/tickets-external?eid=42605309628&ref=etckt" frameborder="0" width="70%" vspace="0" hspace="0" marginheight="5" marginwidth="5" scrolling="auto" allowtransparency="true"></iframe>
</div>
-->
                <p>De ticket pre-sale is beëindigd.</p>
                <hr/>
            </div>
            <div id="tickets" class="container text-center">
                <h3>Voorverkoopspunten</h3>
                <div class="card-deck-wrapper">
                    <div class="card-deck">
                        <div class="card">
                            <a href="http://www.destroate.be"><img class="card-img-top img-responsive" alt="De Stroate" src="/src/img/presale/destroate.jpg"></a>
                        </div>
                        <div class="card">
                            <a href="http://www.4ad.be/nl/"><img class="card-img-top img-responsive" alt="4AD" src="/src/img/partners/4ad.jpg"></a>
                        </div>
                        <div class="card">
                            <a href="http://www.rojo.be"><img class="card-img-top img-responsive" alt="Drankcenter Rojo" src="/src/img/partners/rojo.jpg"></a>
                        </div>
                        <div class="card">
                            <a href="https://www.facebook.com/HOUSE-of-Tattoo-1259382754075973/"><img class="card-img-top img-responsive" src="/src/img/presale/houseoftattoo.jpg"></a>
                        </div>
                        <div class="card">
                            <a href="https://www.facebook.com/Zimbakortrijk/"><img class="card-img-top img-responsive" src="/src/img/presale/zimbashop.jpg"></a>
                        </div>
                    </div>
                </div>
                <br/>
