        ...
        <div class="content container">
            ...
            <div id="contact" class="card-deck-wrapper">
                <div class="card-deck">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">team artists<br/>camping</p>
                        </div>
                        <div class="card-footer">
                ...
                <div class="card-deck">
                    <div class="card">
                        <div class="card-body">
                            <h5 href="/en/crew/lalita_vandenweghe.php" class="card-title">Thomas Bakeland</h5>
                            <p class="card-text">team artists<br/></p>
                        </div>
                        <div class="card-footer">
                            <p class="text-muted"><i class="fas fa-info text-muted"></i><a> Team Member</a></p>
                        </div>
