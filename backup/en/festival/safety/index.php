<html>
    ...
    <body>
        ...
        <div id="safety" class="content container">
            <br/>
            <h3 class="display-7 text-center">Safety @ Irie Vibes</h3>
            <div  id="evacuation_plan" class="text-center">
                <a href="/en/festival/safety/evacuation/">
                    <img class="img-responsive rounded" width="30%" src="/src/img/emergency_exit.jpg">
                    <h3 class="display-6">View our Evacuation Plan <u>here</u></h3>
                </a>
            </div>            
            <hr/>
            <div id="quality_nights_header" class="text-center clickable">
                <a href="/en/festival/safety/quality_nights/"></a>
                <img class="img-responsive" width="20%" src="/src/img/quality_nights.png">
                <p class="quote">Quality nights, because we care about you!</p>                
            </div>
        </div>
        <hr/>
