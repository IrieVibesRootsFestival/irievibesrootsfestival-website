<html>
    <head>
        ...
        <meta name="Description" content="Irie Vibes Roots Festival is a festival dedicated to bringing ska, reggae, world music and dub into the rural of Kortemark, a small town in Belgium. Come join us this year!">
        <meta name="Keywords" content="dub, reggae, ska, world music, food, festival, Irie, Vibes, Roots, Festival, Koekelarestraat, 16, 8610, Kortemark, tickets, buy, 2018">
        ...
        <meta name="theme-color" content="#e3c46e" />
    </head>
    <body>
        <header>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="nav-link drop-2" alt="Clashfinder" href="https://drive.google.com/file/d/0B3FTI6w1g9LZWTBSbEQ4OURDWEE/view">Overview</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
        ...
        <div id="content" class="container">
            ...
            <div  class="col-md-12">
                <span id="home">
                    <br/>
                    <p class="text-center">
                        Irie Vibes Roots Festival brings the world into Kortemark, colouring the city with positive and peaceful vibrations. This low budget and open minded festival is built by a motivated group of creative volunteers with a shared love of music and a shared ecological awareness.
                        <br/>
                    </p>
                </span>
        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center copyright-notice"><p>Copyright &copy; - vzw GreenForward 2001-2018</p></div>
                    <div class="col-md-3">
