        ...
        <div id="news" class="container content">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8">
                    <a class="article" href="/en/news/article/mei_plastic_vrei.php">
                        <h3>May Plastic-Free</h3><h5>May 1st 2018</h5>
                        <p>The hard working volunteers at Irie Vibes have decided it was time to take it one step further! Come along with us on this journey to make the month of May plastic-free. ban plastic straws, cups, disposable bags,.. Read More...
                        </p>
                        <hr/>
                    </a>
                </div>
                ...
                <div class="col-sm-0 col-md-2"></div>
                <div class="col-sm-12 col-md-8">
                    <a class="article" href="/en/news/article/hot_like_a_sauna.php">
                        <h3>Hot Like A Sauna</h3><h5>December 23rd 2017</h5>
                        <p>After a night long of hard work, grooving dub and amazing effects, a winner has been picked from the contestors.
                            The winner of Hot Like A Sauna's dub contest will open the Dub Castle on Irie Vibes Roots Festival 2018! Read More...
                        </p>
                        <hr/>
                    </a>
                </div>
                ...
                <div class="col-sm-0 col-md-2"></div>
                <div class="col-sm-12 col-md-8">
                    <a class="article" href="/en/news/3/">
                        <h3>Christmas Market</h3><h5>December 16th 2017</h5>
                        <p>Vzw GreenForward is proud to announce that a team of motivated volunteers will be holding a stand at the Christmas Market in Handsam (Handzame). Special treats and unique gimmicks are to be discovered! Read More...
                        </p>
                        <hr/>
                    </a>
                </div>
                ...
                <div class="col-sm-0 col-md-2"></div>
                <div class="col-sm-12 col-md-8">
                    <a class="article" href="/en/news/1/">                        
                        <h3>Irie Vibes grows Green</h3><h5>No date known</h5>
                        <p>Year after year, Irie Vibes Roots Festival strives to achieve more and better initiatives to encourage the ecological vision and responsibility it carries by the name Irie Vibes Grows Green. This means that we can assure you we are trying our best to keep any- and everything as clean as we can! Recycle // Upcycle. Read More...
                        </p>
                        <hr/>
                    </a>
                </div>
