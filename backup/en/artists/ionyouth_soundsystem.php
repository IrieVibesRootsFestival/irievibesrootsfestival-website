<html>
    <head>
        ...
        <title>Artist - Ionyouth Soundsystem - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Ionyouth Soundsystem</h2>
                    <p>Ionyouth Soundsystem is based in Limburg, not far from Irie Vibes' Hometown! Please welcome back Ionyouth Soundsystem to this year's Irie Vibes Roots Festival's Dub Castle! </p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/ionyouth.jpg" alt="Ionyouth Soundsystem">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Performances</h2>
                    <div class="text-center roboto color-dub-castle">Dub Castle</div>
                </div>
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/W0FMM7RVNHc" allowfullscreen></iframe>
                    </div>
