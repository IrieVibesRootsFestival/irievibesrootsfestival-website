<html>
    <head>
        ...
        <title>Artist - Channel One Soundsystem - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Channel One Soundsystem</h2>
                    <p>We are very excited to present the first name for Irie Vibes 2018. All the way from London, UK, with their full soundsystem for a whopping 6 hour solo session, shall be none other than the roots entertainers CHANNEL ONE SOUNDSYSTEM!</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/page/channelone.jpg" alt="Channel One">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    ...
                    <hr/>
                    <p><span class="h5 text-white strong">Friday: </span><span class="h5">10PM - 4AM</span></p>
                    <hr/>
                </div>
                <div class="col-md-5 text-center">
                    <img class="img-responsive rounded" src="/src/img/artists/page/channelone_system.jpg" alt="Channel One's Massive Soundsystem">
                </div> 
            </div>
            <hr/>
        </div>
