<html>
    <head>
        ...
        <title>Artist - Dub-Up Hifi - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Dub-Up Hifi</h2>
                    <p>Dub-Up Hifi is ready to bring you moving rythms right in our Dub Castle. Get ready, it's bound to get big!</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/dubup_hifi.jpg" alt="Dub-Up Hifi">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                ...
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/BlC8h430R00" allowfullscreen></iframe>
                    </div>
                    <div class="text-center"><small>Video by <a href="https://www.youtube.com/channel/UC62U-frdqEE5jXIBSNp4QsA">Dub-Up Hifi</a></small></div>
                </div> 
            </div>
            <hr/>
        </div>
