<html>
    <head>
        ...
        <title>Artist - Djoels - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Djoels Ink</h2>
                    <p>As an award-winning artist and winner of "Ink Masters van de lage landen", Djoels is specialized in portraits and realistic artwork. Besides making tattoo-art, making enormous oil paintings and graphitti paintings are one of her big passions where she manages to express herself to the fullest.</p>
                    <p>Therefor, we are proud to announce that Djoels (Ink) will be attending Irie Vibes Roots Festival, and providing us with eyecatching artwork on Friday and Saturday!</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="img-responsive rounded" src="/src/img/artists/page/djoels.jpg" alt="Djoels">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Performances</h2>
                    <div class="text-center roboto text-white">Animation</div>
                    <div class="text-center roboto">Throughout Friday and Saturday during the festival hours.</div>
                </div>
                <div class="col-md-5 text-center">
                    <img class="img-responsive rounded" src="/src/img/artists/page/djoels2.jpg" alt="Djoels Paintings">
                </div>
            </div>
            <hr/>
        </div>
