<html>
    <head>
        ...
        <title>Artist - Kiraden Soundsystem - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Kiraden Soundsystem</h2>
                    <p>Kiraden Sounsystem is a newcomer to Irie Vibes Roots Festival this year! We're hoping for some great rythms in our Dub Castle.</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/kiraden.jpg" alt="Kiraden Soundsystem">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
