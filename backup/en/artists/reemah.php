<html>
    <head>
        ...
        <title>Artist - Reemah - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Reemah</h2>
                    <p></p>
                </div>
                <div class="col-md-5 text-center">
                    <div class="embed-responsive embed-responsive-4by3 rounded">
                        <video class="embed-responsive-item" src="/src/vid/33920906_2329672047050441_6168872474798626159_n.mp4" controls></video>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="d-none d-sm-block embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/Kv5lu-CaNrA" allowfullscreen></iframe>
                    </div>
                    <div class="text-center"><small><a href="http://www.reemahmusic.com">Video by Reemah</a></small></div>
                </div> 
            </div>
            <hr/>
        </div>
