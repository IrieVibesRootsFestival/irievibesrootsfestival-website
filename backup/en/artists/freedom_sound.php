<html>
    <head>
        ...
        <title>Artist - Freedom Soundsystem - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Freedom Soundsystem</h2>
                    <p>Freedom Soundsystem, influenced by JAH Shakka Soundsystem and coming from East Anglia is now coming to Irie Vibes' Dub Castle! Spread the word and enjoy the vibes.</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/freedom_sound.jpg" alt="Freedom Soundsystem">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
