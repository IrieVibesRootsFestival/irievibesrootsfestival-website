<html>
    <head>
        ...
        <title>Artist - Seekaman - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Seekaman</h2>
                </div>
                <div class="col-md-5 text-center">
                    <a href="/en/artists/seekaman.php"><img class=" d-none d-sm-blockimg-responsive rounded" src="/src/img/artists/page/seekaman.jpg" alt="seekaman"></a>
                </div>  
            </div>
            <div class="row">
                <div class="col-md-7">
                ...
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/kdmbOU39Q80" allowfullscreen></iframe>
                    </div>
                </div>   
            </div>  
            <br/>
