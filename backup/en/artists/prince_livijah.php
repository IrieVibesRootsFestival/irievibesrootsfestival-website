<html>
    <head>
        ...
        <title>Artist - Prince Livijah - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Prince Livijah</h2>
                    <p>Prince Livijah is here to warm up the tent on their full soundsystem. This is bound to get spectacular!</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/prince_livijah.jpg" alt="Prince Livijah">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
