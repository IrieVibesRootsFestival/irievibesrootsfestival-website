<html>
    <head>
        ...
        <title>Artist - Fheeta & The Westfrontband - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <p>Fheeta & The Westfrontband are the winners chosen by our Roots Rally visitors. </p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/fheetawestfrontband.jpg" alt="Fheeta & The Westfrontband">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
