<html>
    <head>
        ...
        <title>Artist - Roots Rally Winners - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Fheeta & The Westfrontband</h2>
                    <p>Fheeta & The Westfrontband are the winners chosen by our Roots Rally visitors. <small><a href="/en/artists/fheetawestfrontband.php">More Info...</a></small></p>
                </div>
                <div class="col-md-5 text-center">
                    <img class=" img-responsive rounded" src="/src/img/artists/page/fheetawestfrontband.jpg" alt="Fheeta & The Westfrontband">
                </div>
            </div>
            <hr/>
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Stawl & Black Lion</h2>
                    <p>Stawl & Black Lion are the winners chosen by our Roots Rally Jury members. <small><a href="/en/artists/strawlblacklion.php">More Info...</a></small></p>
                </div>
                <div class="col-md-5 text-center">
                    <img class=" img-responsive rounded" src="/src/img/artists/page/strawlblacklion.jpg" alt="Strawl & Black Lion">
                </div>
            </div>
            <hr/>
        </div>
