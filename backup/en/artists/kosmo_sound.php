<html>
    <head>
        ...
        <title>Artist - Kosmo Sound - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Kosmo Sound</h2>
                    <p>We're proud to present this Belgian talent right from Ghent on our stage! This young band has found the ideal combination of tight pumping rhythm section and spread out melodies suprising a broad audience and making dancing irresistable.</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/page/kosmo_sound.jpg" alt="Kosmo Sound">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Performances</h2>
                    <div class="text-center roboto color-mainstage">Mainstage</div>
                </div>
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/X1YquCJHrZE" allowfullscreen></iframe>
                    </div>
                    <div class="text-center"><small>Video by AntiART</small></div>
                </div> 
            </div>
            <hr/>
        </div>
