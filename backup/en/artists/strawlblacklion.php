<html>
    <head>
        ...
        <title>Artist - Strawl & Black Lion - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Strawl & Black Lion</h2>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/page/strawlblacklion.jpg" alt="Strawl & Black Lion">
                </div>  
            </div>
            <div class="row">
                <div class="col-md-7">
