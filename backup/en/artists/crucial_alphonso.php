<html>
    <head>
        ...
        <title>Artist - Crucial Alphonso - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Crucial Alphonso</h2>
                    <p>Crucial Alphonso, a (fairly) local artist from Antwerp, is bringing his dub and steppers music all the way to Kortemark for us to enjoy. Have a warm welcome!</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/crucial_alphonso.jpg" alt="Crucial Alphonso">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                ...
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/JONlpmaWD0A" allowfullscreen></iframe>
                    </div>
                    <div class="text-center"><small>Video by <a href="https://www.youtube.com/channel/UCsBqmYr7gXys0gmZr9h1Cmw">Basswarriorz</a></small></div>
                </div> 
            </div>
            <hr/>
        </div>
