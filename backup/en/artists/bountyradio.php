<html>
    <head>
        ...
        <title>Artist - DJ Bounty Radio - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">DJ Bounty Radio</h2>
                    <p>On Thursday, DJ Bounty Radio will be delivering positive and uptempo Afro-Latin-Caribbean vibes that will bring you paradise while renowned chef <a href="/en/artists/foodvibes.php">Nicolas Decloedt</a> shows off his amazing cooking skills on <a href="/en/artists/foodvibes.php">Irie Vibes' Food Vibes</a> for us. Enjoy!</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/bountyradio.jpg" alt="DJ Bounty Radio">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    ...
                    <hr/>
                    <p><span class="h5 text-white strong">Thursday: </span><span class="h5">6PM - 10PM</span></p>
                    <hr/>
                </div>
                <div class="col-md-5">
                </div> 
