<html>
    <head>
        ...
        <title>Artist - Chalice Soundsystem - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Chalice Soundsystem</h2>
                    <p>With a history on Irie Vibes Roots Festival, we're proud to bring you back Chalice Soundsystem, right from Lille!</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/page/chalice.jpg" alt="Chalice Soundsystem">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Performances</h2>
                    <div class="h4 text-center roboto color-dub-castle">Dub Castle</div>
                    <hr/>
                    <p><span class="h5 text-white strong">Saturday: </span><span class="h5">1PM - 9PM</span></p>
                    <hr/>
                    <p><span class="h5 text-white strong">Saturday: </span><span class="h5">11PM - 4AM</span></p>
                    <hr/>
                </div>
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/LOdp6Vl0chU" allowfullscreen></iframe>
                    </div>
                    <div class="text-center"><small>Video by <a href="https://www.youtube.com/channel/UCmksEPfpA9B0NyNoDOMc7lA">adilisha</a></small></div>
                </div> 
            </div>
            <hr/>
        </div>
