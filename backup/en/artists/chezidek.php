<html>
    <head>
        ...
        <title>Artist - Chezidek - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Chezidek</h2>
                </div>
                <div class="col-md-5 text-center">
                    <a href="http://www.chezidekreggae.com"><img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/page/chezidek.jpg" alt="Chezidek"></a>
                </div> 
            </div>
            <div class="row">
                <div class="col-md-7">
                ...
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/O3cPx6TZFSo" allowfullscreen></iframe>
                    </div>
                    <div class="text-center"><small>Video by Chezidek</small></div>
                </div>
            </div>
        </div>
        <footer class="footer">
