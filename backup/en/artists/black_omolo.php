<html>
    <head>
        ...
        <title>Artist - Black Omolo - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Black Omolo</h2>
                    <p>We're proud to present Black Omolo as another talent at Irie Vibes! Born in Kenya and brought up in the Netherlands later on, Black Omolo has been making music since she was 5 years old. She discovered her ancestors and family traditions later on, which drove her right into making Roots music.</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/black_omolo.jpg" alt="Black Omolo">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    ...
                    <hr/>
                    <p><span class=" h5 text-white strong">Saturday: </span><span class="h5">8PM - 9:15AM</span></p>
                    <hr/>
                </div>
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/F9G770Jc67o" allowfullscreen></iframe>
                    </div>
                    <div class="text-center"><small>Video by <a href="https://www.reggaeville.com">Reggaeville</a></small></div>
                </div> 
            </div>
            <hr/>
        </div>
