<html>
    <head>
        ...
        <title>Artist - Queen Omega - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div id="artist-page" class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Queen Omega</h2>
                    <p>Right from Trinidad, Queen Omega is here to surprise you with thrilling rythms and stuning vocals. Turn up!</p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/queen_omega.jpg" alt="Queen Omega">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                ...
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/5-tkWuUO6C8" allowfullscreen></iframe>
                    </div>
                    <div class="text-center"><small>Video by Reggaeville</small></div>
                </div> 
            </div>
            <hr/>
        </div>
