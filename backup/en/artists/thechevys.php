<html>
    <head>
        ...
        <title>Artist - The Chevys - Irie Vibes</title>
    </head>
    <body>
        <header>
        ...
        <div class="content container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">The Chevys</h2>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/thechevys.jpg" alt="The Chevys">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
