<html>
    <head>
        ...
        <title>Artist - Andrew Tosh - Irie Vibes</title>
    </head>
    <body>
        <header>
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="nav-link drop-2 active" href="/en/artists">Artists</a></li>
        ...
        <div id="artist-page" class="content container">
            <br/>
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Andrew Tosh</h2>
                    <p>Andrew Tosh, son of Peter Tosh and nephew of Bunny Wailer, has strong vocal resemblance of his late father. Tosh was exposed to reggae music from an early age. His first recording session was in 1985 and resulting in the single “Vanity Love”. He moved on to work with the greatest. In 1989 his his album Make Place for the Youth was nominated for a Grammy Award for Best Reggae Album. 
                    </p>
                    <hr/>
                    <p><i>Andrew Tosh will be collaborating with <a href="/en/artists/queen_omega.php">Queen Omega</a> on Saturday!</i></p>
                </div>
                <div class="col-md-5 text-center">
                    <img class="d-none d-sm-block img-responsive rounded" src="/src/img/artists/page/andrew_tosh.jpg" alt="Andrew Tosh">
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    <h2 class="display-artist text-center">Performances</h2>
                    <div class="h4 text-center roboto color-mainstage">Mainstage</div>
                    <hr/>
                    <p><span class="h5 text-white strong">Saturday: </span><span class="h5">12:00AM - 2:30AM</span></p>
                    <hr/>
                </div>
                <div class="col-md-5">
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/embed/1re_xk-m2SY" allowfullscreen></iframe>
                    </div>
                </div> 
            </div>
            <hr/>
