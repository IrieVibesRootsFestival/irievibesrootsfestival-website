 ...
 */
namespace Emthemes\ThemeSettings\Model\Config\Structure;
...
class Reader extends \Magento\Config\Model\Config\Structure\Reader
{
	public function __construct(
        \Emthemes\ThemeSettings\App\Config\FileResolver $fileResolver,
        ...
        $fileName = 'emthemes_settings.xml',
        $idAttributes = [],
