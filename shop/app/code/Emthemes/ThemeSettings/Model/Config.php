...
class Config extends \Magento\Framework\DataObject
{
    ...
    public function __construct(
        ...
        \Emthemes\ThemeSettings\Model\Config\Loader $configLoader,
        \Emthemes\ThemeSettings\App\Config\ValueFactory $configValueFactory,
        ...
        if (isset($groupData['fields'])) {
            ...
            foreach ($groupData['fields'] as $fieldId => $fieldData) {
                ...
                $backendModel = $field->hasBackendModel() ? $field
                    ...
                    ->create();
                /*$backendModel = $field->hasBackendModel() ? $field
                    ->getBackendModel() : $this->_objectManager->create('Emthemes\ThemeSettings\Model\ResourceModel\Config\Data');*/
