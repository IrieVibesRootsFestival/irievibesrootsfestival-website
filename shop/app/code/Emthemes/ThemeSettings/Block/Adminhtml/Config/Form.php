 ...
 */
namespace Emthemes\ThemeSettings\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \Emthemes\ThemeSettings\Helper\Data $settingHelper,
        array $data = []
    ) {
    ...
    public function getConfigValue($path)
    {
    	...
    	$configDataCollection = $this->_objectManager->create('Emthemes\ThemeSettings\Model\ResourceModel\Config\Data\Collection');
    ...
    {
    	return $this->getRequest()->getParam('settheme', '');
    }
