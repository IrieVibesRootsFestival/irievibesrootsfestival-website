...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    public function __construct(
        ...
        \Emthemes\FilterProduct\Model\Rule\Condition\ProductFactory $conditionFactory,
        array $data = []
    ) {
    ...
    public function getNewChildSelectOptions()
    {
        ...
        foreach ($productAttributes as $code => $label) {
            $attributes[] = [
                'value' => 'Emthemes\FilterProduct\Model\Rule\Condition\Product|' . $code,
                'label' => $label,
            ];
        }
        ...
        $conditions = array_merge_recursive(
            ...
            [
                [
                    'value' => 'Emthemes\FilterProduct\Model\Rule\Condition\Combine',
