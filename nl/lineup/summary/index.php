...
<head>
    ...
    <title>Overzicht - Irie Vibes</title>
        ...
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                ...
                <div class="alert alert-warning alert-dismissible fade show d-md-none" role="alert">
                    <strong><i class="fa-solid fa-mobile-screen"></i><i class="fa-solid fa-rotate"></i></strong> Draai je apparaat om deze tabellen te bekijken
            ...
            <div class="col-12 table-responsive">
                <table class="table table-striped table-bordered table-sm">
                    <thead>
                        <tr>
                            <th scope="row" colspan="5" class="table-dark bg-success h3 p1">Donderdag</th>
                        </tr>
                        <tr>
            ...
            <div class="col-12 table-responsive">
                <table class="table table-striped table-bordered table-sm">
                    <thead>
                        <tr>
                            <th scope="row" colspan="4" class="table-dark bg-warning h3 p1">Vrijdag</th>
                        </tr>
                        <tr>
            ...
            <div class="col-12 table-responsive">
                <table class="table table-striped table-bordered table-sm">
                    <thead>
                        <tr>
                            <th scope="row" colspan="4" class="table-dark bg-danger h3 p1">Zaterdag</th>
                        </tr>
                        <tr>
                            <th scope="col"><i class="fa-regular fa-clock"></i></th>
                            <th scope="col">Lion's Den</th>
