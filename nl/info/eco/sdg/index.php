...
<html lang="nl">
    ...
    <body>
        ...
        <div class="container content">         
            <h1 style="margin-bottom:5px" class="display-7 text-center">Duurzame Ontwikkelingsdoelstellingen</h1>
            <br/>
            <div class="row">
                <!-- Main text -->
                ...
                <div class="col-12">
                    ...
                    <p>Vanaf de editie 2021 willen we ook fairtrade producten aanbieden in onze main bar, onze cocktailbar, onze campingbar en onze campingshop.</p>
