...
<html lang="nl">
    <head>
        ...
        <meta property="og:title" content="Onze deelname aan World Cleanup Day"/>
        <meta property="og:description" content="Wij deden mee aan de World Cleanup Day op 21 September 2019." />
    </head>
    <body>
        <?php include($_SERVER['DOCUMENT_ROOT'].'/src/static/pages/header_nl.php');?>
        <div class="container content">         
            <h1 style="margin-bottom:5px" class="display-7 page-header text-center">World Cleanup Day</h1>
            <br/>
            <div class="row">
                <div class="col-12 col-md-9">
                    ...
                    <h3 class="text-irie">Volgende World Cleanup Day: 19/09/2020</h3>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-4 p-1">
                    <picture>
                        ...
                        <img alt="" class="img-fluid rounded" src="/src/img/eco/mooimakers/cleanup-day-poster.jpg"/>
                    </picture>
                </div>
            </div>
        </div>
