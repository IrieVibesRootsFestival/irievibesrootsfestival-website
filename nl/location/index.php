<!DOCTYPE html><html lang="en">
    <head>
        ...
        <title>Locatie - Irie Vibes</title>
        <meta property="og:title" content="Festival locatie"/>
        <meta property="og:description" content="Hier vind je de locatie van het festivalterrein." />
    </head>
    <body>
