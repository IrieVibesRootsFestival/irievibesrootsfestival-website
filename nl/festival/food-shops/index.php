<!DOCTYPE html><html lang="nl">
    <head>
        ...
        <title>(non)Food Shops - Irie Vibes</title>
    </head>
    <body>
        <header>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="nav-link" href="/en/location/">Location</a></li>
                                    <li><a class="nav-link" href="/en/festival/rules/">Festival Rules</a></li>
                                    <li><a class="nav-link" alt="Camping, parking and other places to stay" href="/en//festival/accomodation/">Accomodation</a></li>
                                    <li><a class="nav-link" href="/en/festival/merchandise/">Merchandise</a></li>
                                    <li><a class="nav-link" href="/https://irievibes.be/nl/info/volunteers/">Volunteers</a></li>
                                    ...
                                    <li><a class="nav-link" href="/en/festival/safety/">Safety First</a></li>  
                                </ul>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="nav-link" href="/en/artists">Artists</a></li>
                                    <li><a class="nav-link" href="/en/lineup/">Line-Up</a></li>
                                    <li><a class="nav-link" alt="Clashfinder" href="#">Overview</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="nav-link" href="/en/info/about/">About Us</a></li>
                                    <li><a class="nav-link" href="/en/crew">Crew</a></li>
                                    <li><a class="nav-link" href="/en/info/we_support/">We Support</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
        ...
        <footer class="footer">             <div class="container">                 <div class="row">                     <div class="col-md-3 text-center">                         <a href="/en/info/volunteers" class="btn btn-volunteer">Become Volunteer</a>                     </div>                     <div class="col-md-6 m-auto text-center d-none d-md-block"><p>Copyright &copy; - vzw GreenForward 2002-2021</p></div>                     <div class="col-md-3">                         <div id="btn-social" class="text-center">                             <a href="https://www.facebook.com/IrieVibesRootsFesitval"><i class="fab fa-facebook fa-3x social"></i></a>                             <a href="https://www.instagram.com/irievibesroots/"><i class="fab fa-instagram fa-3x social"></i></a>                             <a href="/src/static/snapchat/"><i class="fab fa-snapchat fa-3x social"></i></a>                         </div>                     </div>                     <!-- Redundant for Mobile Compatibility-->                     <div class="col-md-6 text-center d-block d-md-none"><p>Copyright &copy; - vzw GreenForward 2002-2019</p></div>                 </div>             </div>         </footer>
            <div class="container">
                <div class="row">
