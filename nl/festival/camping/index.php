                        ...
                        <div id="accomodation-nav" class="col-12 col-lg-3 order-lg-2 ">
                            <div class="text-box-2 rounded p-3">
                                <div class="text-box rounded p-2">
                                    <!-- Anchor Navigation -->
                                    <nav class="nav">
                                        <a class="nav-link text-irie" href="#camping_location">Locatie & prijs</a>
                                        <a class="nav-link text-irie" href="#camping_hours">Openingsuren</a>
                                        <a class="nav-link text-irie" href="#agreements">Afspraken</a>
                                        <a class="nav-link text-irie" href="#facilities">Faciliteiten</a>
                                        <a class="nav-link text-irie" href="#food_drinks">Voedsel</a>
                                        <a class="nav-link text-irie" href="#entrance_exit">In- en uitgang</a>
                                        <a class="nav-link text-irie" href="#camping_crimes">Camping-misdaden</a>
                                        <a class="nav-link text-irie" href="#personal_belongings">Personal Belongings</a>
                                        <a class="nav-link text-irie" href="#home"><i>The 7 Commandments</i></a>
                                        <a class="nav-link text-danger" href="/src/static/grondplan_camping.pdf">Ground Plan</a>
                                    </nav>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-9 order-lg-1">
                            <div class="row">
                                ...
                                <div id="camping_location" class="col-12 anchor">
                                    ...
                                    <p>De Irie Camping bevindt zich op het <b>festivalterrein</b>.</p>
                                    <p>De camping gaat open op Donderdag om 14u en sluit op zondag om 11u. We verwachten dan ook dat alle bezoekers bij aanvang van de sluiting de camping (net) achterlaten en de camping te verlaten.</p>                     
                                    <p class="mb-0"><b>Het Irie Vibes Roots Festival is open tot het publiek op:</b></p>
                                    <ul>
                    ...
                    De parking kost <b>€5</b> en is aan de overkant van het festivalterrein. Bij het oprijden op de parking krijg je na betaling een betalingsbewijs dat je achter je ruit plaatst. Verlies dit blaadje niet! Je kan de parking niet meer op zonder dit blaadje.<br/> Als je met de auto komt, bekijk dan misschien de <a href="https://www.carpool.be/nl/common/app">Carpool.be App</a>!
                                ...
                                <div id="facilities" class="col-12 col-md-6">
                                    ...
                                    <ul>
                                        ...
                                        <li>Zondag van 9u tot 12u (sluitingstijd)</li>
                                    </ul>
                        ...
                        <div class="col-12 order-md-10">
                            <div class="text-box-2 rounded p-3">
                                <div class="text-box rounded p-2">
                                    ...
                                    <ol>
                                        <li>As loving shepherds we want you to be safe so only the fire in your heart can burn. Between the tents every flame is forbidden,  so safety we earn</li>
                                        <li>Honor thy mother and respect her.  What you don't throw in your momma's living room; you don't throw on Mother Nature’s ground</li>
                                        <li>Thou shalt not steal unless it's a heart, thou shalt not leave values in thy tent; so for thieves no reward, only hell in the end end end end end (<i>dubwise</i>)</li>   
                                        <li>Remember the sabbath day , the campsite is for people to rest thou can reason at low level here but keep thy roar for the fest</li>
                                        <li>Food & drinks can be brought to the camp</li>
