...
<html lang="nl">
    <head>
        ...
        <meta property="og:description" content="Terug naar waar het allemaal begon: Irie Vibes nodigt je uit naar hun Back to The Roots editie van het Irie Vibes Roots Festival in hartje zomer 2022 in Kortemark." />
    </head> 
    <body>
            ...
            <div id="home-text" class="col-12 col-md-8 ">
                ...
                <div id="home_invite-text">
                    ...
                    <div id="home_invite-third" class="text-end text-irie-red pe-md-4">
                        ...
                        <p class="text-justify">
                            Op zoek naar tickets? Koop ze nu! Een camping ticket garandeert dat je een plaatsje op de camping krijgt. Tickets en prijzen kan je <a class="text-danger" href="/nl/tickets/"><i class="fas fa-link fa-xs" style="font-size: 0.6rem;"></i>hier</a> vinden. Vroege vogels kunnen zich wagen met een Early Bird ticket, en een korting scoren!
                        </p>
                    </div>
                </div>
            </div>
