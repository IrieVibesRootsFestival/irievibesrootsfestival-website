                ...
                <div id="home_invite-text">
                    <div id="home_invite-first" class="text-end text-irie-green pe-md-4">
                        ...
                        <b>
                            ...
                            <p>
                                ...
                                in de footer, of <a class="text-irie-success" href="#footer_main"><i class="bi bi-info-circle"></i><b>hier</b></a> klikken.
                            </p>
                        </b>
                    </div>
                    <div id="home_invite-second" class="text-left text-irie-yellow">
                        ...
                        <p class="text-justify">
                            ...
                            Mash down! Ga naar de <a class="text-warning" href="/nl/info/volunteers/"><i class="fas fa-link fa-xs" style="font-size: 0.6rem;"></i>vrijwilligers pagina</a> om te
                    ...
                    <div id="home_invite-third" class="text-end text-irie-red pe-md-4">
                        ...
                        <p class="text-justify">
                            ...
                            camping krijgt. Tickets en prijzen kan je <a class="text-danger" href="/nl/tickets/"><i class="fas fa-link fa-xs" style="font-size: 0.6rem;"></i>hier</a> vinden. Vroege vogels
