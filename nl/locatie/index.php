                        ...
                        <span class="navbar-text">
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link language text-muted" href="/en/location/"><img src="/src/img/flags/blank.gif" class="flag flag-gb" alt="Czech Republic" /><span class="sr-only">(current)</span></a>
                                </li>
                            </ul>
                        </span>
                    </div>
