<div id="lineup" class="row text-center display-none">
    ...
    <div id="stage_tent" class="col-md-6">
        <div class="row py-2 mb-3 border border-lg border-success rounded bg-img">
            ...
            <!-- Singer + Band block-->
            <div class="row border border-lg border-dark rounded m-2">
    ...
    <!-- Open Air
<div div="stage_air" class="col-md-6">
<div class="row py-2 mb-3 border border-lg border-danger rounded bg-img">
<div class="col-12"><p class="text-center bg-danger rounded text-white">Open Air</p></div>
</div>
</div> 
-->
    ...
    <div id="wrapper" class="col-md-6 px-0">
        ...
        <div id="stage_kids" class="col-12">
            <!-- Kinderdorp -->
