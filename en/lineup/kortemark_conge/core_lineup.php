<div id="kc" class="row text-center d-none">
    <div id="stage_tent" class="col-md-6">
        <!-- Big Tent -->
        <div class="row py-2 mb-3 border border-lg border-success rounded bg-img">
            <div class="col-12"><p class="bg-success rounded text-white">Lion's Den</p></div>
            <div class="col-6">
    ...
    <div id="stage_air" class="col-md-6">
        <!-- Outside Tent -->
        <div class="row py-2 mb-3 border border-lg border-danger rounded bg-img">
            <div class="col-12"><p class=" bg-danger rounded text-white">Open Air</p></div>
            <div class="col-12"><div class="text-white bg-dark p-1 rounded h4">18:00</div></div>
            <div class="col-6">
                <div class="img-fluid img-container">
    ...
    <div id="stage_tent_outside" class="col-md-6">
        <!-- Field Tent -->
        <div class="row py-2 mb-3 border border-lg border-sand rounded bg-img">
            <div class="col-12"><p class="bg-sand  rounded text-white">Inner Circle</p></div>
            <div class="col-6">
    ...
    <div id="stage_kids" class="col-md-6">
        <!-- Kinderdorp -->
        <div class="row py-2 mb-3 border border-lg border-warning rounded bg-img">
            <div class="col-12"><p class="bg-warning rounded text-white">Little Lion</p></div>
            <div class="col-6">
                <div class="text-white bg-dark p-1 rounded h4">18:00</div>
                <div class="img-fluid img-container">
