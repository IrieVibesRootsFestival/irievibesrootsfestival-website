        ...
        <div class="container content">
            <div class="row">
                ...
                <div class="col-12 py-3">
                    <p class="mx-md-5">Are you a resident from Kortemark? Get your tickets at €10 a day, upon showing your ID. <br/>For more info: <a href="mailto:inf@irievibes.be">info@irievibes.be</a></p>
                </div>
                <div id="tickets" class="col-12 text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-2 p-1"><div class="rounded bg-white p-1"><a href="https://www.facebook.com/cafebotecogent/"><img alt="" class="rounded img-fluid" alt="Café Botègo" src="/src/img/presale/boteco.jpg"></a><p class="my-1">Ghent</p></div></div>
