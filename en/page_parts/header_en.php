                ...
                <ul class="navbar-nav mr-auto d-lg-flex align-items-lg-center px-2 px-md-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/en/location/"><i class="bi bi-pin-map"></i></i> Location</a></li>
                            <li><a class="dropdown-item" href="/en/festival/rules/"><i class="bi bi-megaphone"></i></i> Festival Rules</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/en/lineup/"><i class="bi bi-calendar-range"></i> Line-Up</a></li>
                            <li><a class="dropdown-item" href="/en/lineup/posters/"><i class="bi bi-scroll"></i> Posters</a></li>
                            <li><a class="dropdown-item" href="/en/lineup/livestream/"><i class="bi bi-video"></i> Livestream</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
