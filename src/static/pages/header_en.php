        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto d-lg-flex align-items-lg-center px-2 px-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/en/tickets/"><i class="fas fa-ticket-alt d-lg-none">&nbsp;</i>Tickets</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link drop-2" href="/en/info/eco/groene-vent-award/"><i><i class="fas fa-award"></i> Groene Vent</i></a></li>
