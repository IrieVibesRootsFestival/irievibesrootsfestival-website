    ...
    <div class="container pt-2">
        <div class="row">
            <div class="col-12 col-md-3 footer-brand animated fadeInLeft text-center">
                <img src="/src/img/greenforward-large.png" class="img-fluid p-3 rounded-circle" alt="Greenforward Logo">
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <ul class="pages">
                            ...
                            <li><a href="/fr/crew/">Crew</a></li>
                            <li><a href="/fr/info/eco/trim-the-footprint/">Trim The<br/>Footprint</a></li>
                        </ul>
                    </div>
                    <div class="col-12 col-md-6">
                        <ul class="list">
                            ...
                            <li><a href="/fr/info/trooper/"><img src="https://trooper.be/Content/Assets/02401_favicon_trooper.png" style="margin-top:-6px;"> Trooper</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-3">
                <h4>— Newsletter —</h4>
                <p class="py-1">Abonnez-vous à notre newsletter</p>
                <span>
                    ...
                    <div id="mc_embed_signup">
                        <form action="https://irievibes.us8.list-manage.com/subscribe/post?u=d99c4a0da87cf14cbb7acb09c&amp;id=ec0420bb34" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                            <div id="mc_embed_signup_scroll">
                                ...
                                <label class="sr-only" for="subscribe-email">Adresse e-mail</label>
        ...
        <div class="row">
            <div class="col-md-3 text-center">
                <a href="/en/info/volunteers" class="btn btn-volunteer">Devenir volontaire</a>
            </div>
            <div class="col-md-6 m-auto text-center d-none d-md-block"><p>Copyright &copy; - vzw GreenForward 2001-2019</p></div>
            <div class="col-md-3">
            ...
            <div class="col-md-6 text-center d-block d-md-none"><p>Copyright &copy; - vzw GreenForward 2001-2019</p></div>
        </div>
    </div>
</footer>