        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item dropdown-toggle">
                        <a href="#" class="nav-link" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fas fa-list-alt d-lg-none">&nbsp;</i>Programma</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link drop-2" href="/nl/lineup/livestream/"><i class="fas fa-video"></i> Livestream</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown-toggle">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link drop-2" href="/nl/info/eco/food-waste-facts"><i class="fas fa-carrot"></i> Food Waste Facts</a></li>
