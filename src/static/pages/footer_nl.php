                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <ul class="pages">
                            ...
                            <li><a href="/nl/info/trim-the-footprint/">Trim The<br/>Footprint</a></li>
                        </ul>
                    </div>
                    <div class="col-12 col-md-6">
                        <ul class="list">
                        ...
                        <form action="https://irievibes.us8.list-manage.com/subscribe/post?u=d99c4a0da87cf14cbb7acb09c&amp;id=ec0420bb34" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                            <div id="mc_embed_signup_scroll">
                                ...
                                <div class="text-center">
                                    <button type="submit" value="Subscribe"id="mc-embedded-subscribe"class="btn btn-volunteer mt-0"><a>Abonneer</a></button>
                                </div>
                            </div>
                        </form>
                    </div>
