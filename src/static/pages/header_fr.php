...
-->
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link drop-2" href="/fr/info/trim-the-footprint/">Trim The <br/> Footprint</a></li>
                            <li><a class="nav-link drop-2" href="/fr/info/eco-team/">Team eco</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav ml-auto d-md-flex align-items-center">
                    <li class="nav-item dropdown">
                        <a href="#" class=" nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fas fa-globe-americas"></i><span class="d-lg-none"> Langue</span><span class="dropdown-toggle"></span></a>
