    ...
    <body>
        ...
        <div class="container content">
            ...
            <div class="row"> 
                ...
                <div class="col-12">
                    <h3 class="text-irie text-uppercase">22 juillet 2022 à partir de 18u00</h3>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>avec le support d’Interreg France-Wallonie-Vlaanderen</li>
                                <li>les initiatives écologiques à l’honneur</li>
                            </ul>
                            <div class="row m-0 p-0">
                                <div class="col-12 col-md-4">
                                    <div class="embed-responsive embed-responsive-16by9 rounded mb-3">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>marché mondial : associations et projets locaux</li>
                                <li>objectifs de développement</li>
                            </ul>
                            <p>
                                <br/>avec Noord Zuid Kortemark en Weedo Tanzania<br/> <a href="https://www.facebook.com/weedo.womenempowering/">https://www.facebook.com/weedo.womenempowering/</a>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>Recycle art</li>
                                <li>Village d’enfants</li>
                                <li>Coiffures folles</li>
                                <li>Qi Gong</li>
                                <li>Workshops</li>
                                <li>Construire un monde meilleur</li>
                            </ul>
                        </li>
                    </ul>
                </div>
