            ...
            <div class="col-12 col-md-8" id="home_sidebar-left">
                ...
                <div class="text-left text-success">
                    ...
                    <p class="text-justify">
                        ...
                        Placez un signet de notre <a class="text-success" href="/fr/lineup/"><i class="fas fa-link fa-xs" style="font-size: 0.6rem;"></i>page de line-up</a> sur votre
                ...
                <div class="text-md-right text-warning">
                    ...
                    <p class="text-justify text-md-right">Ici chez Irie Vibes, la famille est importante. Comme une
                        ...
                        vous, il serait impossible de réaliser ce rêve. Mash Down! Allez sur la <a class="text-warning" href="/fr/info/volunteers/"><i class="fas fa-link fa-xs" style="font-size: 0.6rem;"></i>page
