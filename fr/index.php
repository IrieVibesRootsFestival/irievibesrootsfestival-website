...
<head>
    ...
    <meta property="og:title"
        content="Irie Vibes Roots Festival 2022 - Découvrez le monde du festival Irie Vibes Roots" />
    <meta property="og:description"
        content="De retour à l'endroit où tout a commencé: Irie Vibes vous invite à l'édition Back to The Roots du festival Irie Vibes Roots en plein été 2022 à Kortemark." />
</head>
    ...
    <div class="container content">
        ...
        <div class="col-12 col-md-8" id="home_sidebar-left">
            ...
            <div id="home-text" class="col-12 col-md-8">
                ...
                <div class="text-left text-success">
                    ...
                    <p class="text-justify">
                        Irie Vibes retourne là où tout a commencé. Irie Vibes 2022 sera à nouveau une rétrospective de
                        nos racines, souvenirs et événements. Nous vous invitons à faire partie du <b>retour d'Irie
                            Vibes au festival Roots 2022</b>, où la tête, le cœur et le corps se rencontrent dans un
                        fantastique spectacle de couleurs et de sons.
                        Placez un signet de notre <a class="text-success" href="/fr/lineup/"><i
                                class="fas fa-link fa-xs" style="font-size: 0.6rem;"></i>page de line-up</a> sur votre
                        écran d'accueil. Irie!
                    </p>
                </div>
                <div class="text-md-right text-warning">
                    <h1 class="mt-3 mb-0 px-3 quote">one love</h1>
                    <p class="text-justify text-md-right">Ici chez Irie Vibes, la famille est importante. Comme une
                        grande famille qui construit pour un avenir encore plus grand. Sans l'aide de personnes comme
                        vous, il serait impossible de réaliser ce rêve. Mash Down! Allez sur la <a class="text-warning"
                            href="/fr/info/volunteers/"><i class="fas fa-link fa-xs" style="font-size: 0.6rem;"></i>page
                            des bénévoles</a> pour voir si c'est pour vous. Family thing!</p>
                </div>
                <div class="text-left text-danger">
                    ...
                    <p class="text-justify">
                        ...
                        au camping. Les billets et les prix peuvent être trouvés <a class="text-danger"
                            href="/fr/tickets/"><i class="fas fa-link fa-xs" style="font-size: 0.6rem;"></i>ici</a>.
                    </p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="fb-page rounded" data-href="https://www.facebook.com/IrieVibesRootsFesitval"
